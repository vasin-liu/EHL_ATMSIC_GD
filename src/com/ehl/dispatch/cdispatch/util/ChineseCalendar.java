...
public class ChineseCalendar {
	...
	static String sCalendarLundarToSolar(String time) {
		Object object[] = time.split("-");
        int iSYear, iSMonth, iSDay;
        int iYear,iMonth,iDay;
        iYear = Integer.parseInt(object[0].toString());
        iMonth = Integer.parseInt(object[1].toString());
        iDay = Integer.parseInt(object[2].toString());
