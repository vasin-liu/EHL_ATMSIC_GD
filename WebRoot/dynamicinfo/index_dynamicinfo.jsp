...
<html>
	...
	<frame src="#" scrolling="no" noresize /> 
		<frameset  name="frmst" cols="*" framespacing="0" frameborder="no">
			<frame name="moduletarget" src="ehl/dynamicinfo/DynamicInfo.jsp?funcId=59" style="border-left:0px #00a3e4 solid">
		</frameset>
		<noframes></noframes>
	</frameset>
	<frame src="#" scrolling="no" noresize /> 
