...
<head>
	...
	<title><msg:Common_zh.userRela.jsp.title></title>
...
<table  id="systable" width="802" border="0" align="center" cellpadding="0"
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<table width="100%" height="88%" border="0" align="center">
							...
							<tr>
							<tr>
								<td align="center" valign="bottom"><br><span class="STYLE1"><msg:Common_zh.userRela.jsp.title></span>
								</td>
							</tr>
							<tr>
								<td valign="top">
								<hr>
								<%
									String tableScript = PageTableUtil.doDataWinGenerate("d_userrela_s");
								%> <%=tableScript%> <br>
								<div id="personbt"></div>
								</td>
							</tr>
