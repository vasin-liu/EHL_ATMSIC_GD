...
<table id="roleTable" width="802" border="0" align="center" cellpadding="0"
	...
	<tr >
		...
		<table  border="0" align="left" cellpadding="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td id="roleTD" width="3" background="../../image/back/back_midleft.gif" height="496"></td>
						<td>
						<table width="100%" height="80%" border="0" align="center">
							...
							<tr>
								<td align="center" valign="bottom"><br><span class="STYLE1"><msg:Common_zh.roleManage.jsp.title></span></td>
					<tr>
							...
							<tr>
								<td height="17" valign="top">
									...
									<table width="95%" border="0" align="center">
										<tr>
											<td width="20%">
											<div align="right"><msg:Common_zh.roleManage.jsp.rname>：</div>
											</td>
											<td width="20%"><input type="text" name="jname" maxLength="20" class="text" /></td>
											<td width="10%">&nbsp;</td>
											<td width="13%" style="display:none">
											<div align="right"><msg:Common_zh.roleManage.jsp.rcode>：</div>
											</td>
											<td width="18%"style="display:none"><input type="text" name="jcode"maxLength="20" class="text" /></td>
										</tr>
									</table>
									<!--  -->	
									</div></td>
							...
							<tr>
								...
								<%
									String tableScript = PageTableUtil.doDataWinGenerate("d_js_s");
								%> 
								<%=tableScript%>
								<br>
								<script type="text/javascript">
				                     window.gridName = "t_js_s";
						    			var grid = eval("mygrid" + window.gridName);
						  				grid.hdr.rows[1].childNodes[0].childNodes[0].innerHTML = ' \
									<span style="vertical-align:super;"><input type="checkbox" id="box" value="0" name="ckb_selectAll1" onclick="checkAllRow(mygridt_js_s);">全选</span>';
				                </script>
								</td>
							</tr>
							<tr>
