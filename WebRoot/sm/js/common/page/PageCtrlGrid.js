...
PageCtrlGrid.prototype={
	url : "common.PageCtrl.getPageUtil.d",
	pageNum : 0, //定义总页数变量
	exeSql : "", //定义SQL语句变量
	currPage : 1, //定义当前页变量
	pageSize : "", //分页大小
	 ...
	 * @param dsName 数据源
	 * @example "PageCtrlGrid.initPage('pageContain','select id,n_id from t_func where 1=1 order by id','d_grid_s','impClassName',12)" 
	 */
	initPage : function(contain,sql,grid,className,customSize,dsName){
	  ...
	  strHTML += "<td align='center' style='align:center;width:24;font-size:9pt'><a href='javascript:void(0);' onclick='PageCtrlGrid.prototype.onFirstPage();'>首页</a></td>";
	  strHTML += "<td align='center' style='align:center;width:1;font-size:9pt'>|</td>";
	  strHTML += "<td align='center' style='align:center;width:24;font-size:9pt'><a href='javascript:void(0);' onclick='PageCtrlGrid.prototype.onPrevPage();'>上页</a></td>";
	  strHTML += "<td align='center' style='align:center;width:1;font-size:9pt'>|</td>";
	  strHTML += "<td align='center' style='align:center;width:24;font-size:9pt'><a href='javascript:void(0);' onclick='PageCtrlGrid.prototype.onNextPage();'>下页</a></td>";
	  strHTML += "<td align='center' style='align:center;width:1;font-size:9pt'>|</td>";
	  strHTML += "<td align='center' style='align:center;width:24;font-size:9pt'><a href='javascript:void(0);' onclick='PageCtrlGrid.prototype.onLastPage();'>末页</a></td>";
	...
	callPageCtrl : function () {
		...
		if (this.impClassName){
			...
			params += "&impClassName=com.ehl.sm.common.page.PageCtrlUIImple";
		}
