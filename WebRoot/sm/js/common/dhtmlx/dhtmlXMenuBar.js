...
dhtmlXMenuBarObject.prototype.setZIndex = function (zIndex) {
	...
	if ((_isIE) && (this.parentNode.style.position == "absolute")) {
...
dhtmlXMenuBarObject.prototype._parseXMLTree = function (that, node, level, parentNode, aTempNode, mode) {
	...
	if ((level == 0) && (that.topMenu.waitCall)) {
...
dhtmlXMenuBarObject.prototype._createPanel = function () {
	...
	div.innerHTML = "<table cellpadding=\"0\" cellspacing=\"0\" class=\"" + this.topMenu.tableCSS + "\" width=\"" + this.width + "\" height=\"" + this.height + "\"><tbody>" + "<tr>" + "<td width=\"3px\" style=\"display:none\"><div class=\"menuHandle\">&nbsp;</div></td>" + "<td class=\"" + this.topMenu.titleCSS + "\" style=\"display:none\">" + this.topMenu.tname + "</td>" + "<td></td>" + "<td align=\"right\" width=\"100%\" class=\"" + this.topMenu.titleCSS + "\">&nbsp;" + this.topMenu.tname + "</td>" + "<td >&nbsp;</td>" + "</tr></tbody></table>";
...
dhtmlXMenuItemObject.prototype._onmousedownX = function (e) {
	if ((!this.objectNode.parentPanel.parentPanel) && (this.objectNode.subMenu)) {
