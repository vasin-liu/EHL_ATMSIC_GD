...
<html>
	<head>
		...
		<title><msg:Common_zh.Global.company></title>
	 ...
	 <body> 
	    <div style="height: 50px;background-image: url(../image/head/head.png)"></div>
	    <div style="height: 29px;background-image: url(../image/head/nav_back.png)"></div>
	    <div id="head_top" class="nav" style="position: absolute;top:2px;right: 2px;">
			<table align="right">
			    <tr height=15>
			      <td colspan="4">
			   ...
			   <tr>
			       <td>
			         <span style="position:relative;visibility: hidden;"><a href="javascript:showPage();"><b>修改密码</b></a>｜</span>
			      </td>
			      <td>
			         <span style="position:relative;visibility: hidden;"><a href="javascript:doLogout('header');"><b>注销</b></a>｜</span>
			      </td>
			      <td>
			         <span style="position:relative;visibility: hidden;"><a href="javascript:showHelpPage('ehl/sysmanage/about.jsp','../../xml/version.xml');"><b>关于</b></a>｜</span>
			      </td>
			      <td>
			         <!-- <span style="position:relative;"><a href="javascript:help('ehl/help/help.jsp');"><b>帮助</b></a></span> -->
			         <span style="position:relative;"><a href="javascript:window.parent.location.href='<%=basePath%>grid.jsp'"><b style="font-size: 15px;">返回</b></a></span>
			      </td>
