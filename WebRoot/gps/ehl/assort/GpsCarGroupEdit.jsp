   ...
   <table width="300" align="center" class="tableInput" id="dataTable">
	...
	<tr>  
        <td class="tdRight" colspan="2"><br>
	        <div align="center">
		      	<input type="image" src="../../images/button/btnsave.gif" 	name="button"  value="<msg:Common_zh.Global.save.desc>"  onClick="save(<%=insrtOrUpdt %>);"/>
		        <input type="image" src="../../images/button/btnreset.gif"  name="button"  value="<msg:Common_zh.Global.reset.desc>" onClick="reset();"/>
		        <input type="image" src="../../images/button/btnclose.gif" 	name="button"  value="<msg:Common_zh.Global.close.desc>" onClick="doClose();"/>
            </div>
        </td>
     </tr>
</table> 
