  ...
  <head>
	...
	<script type="text/javascript">
		...
		{	 
			...
			deptCarTree.setTreeHolderID('divGPSCarTree');
			deptCarTree.serverURI = 'gps.GPSTree.readBranchCarTree.d';
			 
			deptCarTree.setLeafClickHandler(carNodeClicked);
		...
		*/
		...
		function carNodeClicked(itemId,oNode)
		{	
		/*
			if(oNode && oNode.id && oNode.attr == 'GPS_CAR'  )
			{
				window.parent.ifmain.gpsmap.centerCarInfo(oNode.id );
			}
		*/
			if(itemId)
			{
