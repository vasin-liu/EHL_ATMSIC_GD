	...
	//建立GPS车辆地图数据控制对象
    var gpsmap = new InstantMap();    
    gpsmap.readGPSPoints();
    gpsmap.refreshPoints();
...
fillListBox("txtgrouptd","group","100","SELECT distinct(groupid),groupname FROM t_gps_groupinfo order by groupid","","","","gps");
...
fillListBox("txtClassifyQ","catalog","100","SELECT distinct(cataid),cataname FROM t_dict_gpscarcatalog order by cataid","","","","gps");	  