...
DhtmBranchTree.divId = "DhtmBranchTreeHtmlDiv";	//该对象html元素容器的ID

//关闭该层
DhtmBranchTree.close = function()
{
	var id = DhtmBranchTree.divId;
	if($(id))
	{
...
//获取DhtmBranchTree界面中选择的值
DhtmBranchTree.getValue = function(htmlEleId)
{
...
*	LChQ 2008-1-1
*/
function DhtmBranchTree(treeCode,rootCode,rootName,htmlEleId)
{
	var m_imgUri = '';
	var m_left = null, m_top = null;		//显示位置
	var m_width = null, m_height = null;	//显示大小
	
	var m_divId = DhtmBranchTree.divId;		//标识
	...
	this.createTitleHtml = function()
	{
        ...
        { 
        	DhtmBranchTree.getValue( htmlEleId );
        };
