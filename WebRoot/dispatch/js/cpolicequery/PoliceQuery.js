...
function viewPolice(policeId,policeType){
	...
	switch (policeType) {
		case '001001'://交通事故
			var urlStr = "../../ehl/cpoliceedit/accidentEdit.jsp?alarmId="+policeId +"&depttype="+ depttype+"&deptcode="+ deptcode+"&showtype=0";
...
function editPolice(policeId,policeType){
	...
	switch (policeType) {
		case '001001'://交通事故
			var urlStr = "../../ehl/cpoliceedit/accidentEdit.jsp?alarmId="+policeId +"&depttype="+ depttype+"&deptcode="+ deptcode+"&showtype=1";
			var iLeft = (screen.Width-660)/2;
			var iTop = (screen.Height-500)/2;
		...
		case '001002':// 交通拥堵
		   	...
		   	break;
		case '001007': //交通管制
		 	var urlStr = "../../ehl/cpoliceedit/TrafficContrl.jsp?alarmId="+policeId +"&depttype="+ depttype+"&deptcode="+ deptcode;
			window.open(urlStr,"","height=400,width=650,left="+eval(screen.Width-800)/2+",top="+eval(screen.Height-560)/2+"");
			break;
		case '001008'://施工占道
		    var urlStr = "../../ehl/cpoliceedit/RoadBuild.jsp?alarmId="+policeId +"&depttype="+ depttype+"&deptcode="+ deptcode;
...
function delPolice(alarmId,policeType){
	...
	var url = "dispatch.caccident.delPoliceInfo.d";	
	url = encodeURI(url);
