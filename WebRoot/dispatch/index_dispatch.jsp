...
<html>
	<head>
		...
		<script type=text/javascript src="../base/js/style1/iframe.js"></SCRIPT>
	...
	<script type="text/javascript">
		...
		var otherFrame = window.parent;
		var isOther = false;
		function hideDiv(){
			try{
				if(isOtherDutyPromptOpen){
					isOther = true;
				}
			}catch(e){
				isOther = false;
			...
			if(!isOther){
				...
				jQuery(".mainbody").hide();
				dialog('今日值班人员表','iframe:ehl/cpoliceedit/duty.jsp?deptId=<%=deptcode%>','380px','200px','iframe');
			}
		};
		function  cloDiv(){
		...
		//在页面加载完毕后隐藏jqgrid的加载div
		jQuery(document).ready(function(){
			jQuery("#load_tdData",document.frames('moduletarget').document).hide();
		})
		//ShowNodePrivi.setIndexUrl();
	</script>
<body style="padding:0; margin:0" onload="hideDiv();setHomePage('57','<%=uname %>');">
			...
			<tr>
				<td width="10">
					<div class="sidebar" id="frmTitle">
						<iframe frameborder="0" id="sidebar" name="sidebar" scrolling="auto" noresize="noresize" src="lefttree.jsp?funcId=5707"
							style="HEIGHT: 521px; VISIBILITY: inherit; WIDTH: 168px; Z-INDEX: 2" allowtransparency="true">
						</iframe>
					</div>
				</td>
				<td width="8">
					<div class="switch">
						<div style="HEIGHT: 521px; float: left; background: url(../base/image/cssimg/switch.gif) no-repeat center;" onClick="switchSysBar()">
							<font style="FONT-SIZE: 12pt; width: 9px; CURSOR: default;">
								<span class="navPoint" id="switchPoint" title="切换"></span> 
							</font>
						</div>
					</div>
				</td>
				<td>
					<div class="mainbody" style="width: 100%">
						<iframe frameborder="0" id="moduletarget" name="moduletarget" scrolling="auto" noresize="noresize"
							src="ehl/cpoliceedit/allMaterialInfo.jsp?funcId=5707" style="height: 540px; * height: 540px !important; * height: 522px; VISIBILITY: inherit; WIDTH: 100%; Z-INDEX: -1; padding-top: 6px;"
