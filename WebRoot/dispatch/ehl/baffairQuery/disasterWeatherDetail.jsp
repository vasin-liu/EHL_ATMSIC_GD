...
<!-- 
	 ...
	 * 文件名称：disasterWeatherDetail.jsp
	 * 摘 要： 恶劣天气信息
	 * 当前版本：1.0
	 * 作 者：LChQ  2009-4-22
	 * 修改人：
						...
						<TABLE cellSpacing=0 cellPadding=2 width="100%">
							<TBODY>
								...
								<TR class="detailTR1" id="">
									...
									<TD class=queryTD2 id="tdReportPhone"></TD>
									<TD class=queryTD1>
										报警人所在单位：
									</TD>
								...
								<TR>
									...
									<TD class=queryTD2 id="tdFluencyCounty">
									</TD>
									<TD class=queryTD1>
										影响范围：
									</TD>
									<TD class=queryTD2 id="tdFluencyArea"></TD>
									<TD class=queryTD1>
										影响道路：
									</TD>
								...
								<TR class="detailTR1">
									...
									<TD class=queryTD2 id="tdWeatherDesc" >

									</TD>
									<TD class=queryTD1>
										路面情况：
									</TD>
									<TD class=queryTD2 id="tdRoadDesc" colspan=3>
										&nbsp;
									</TD>
								 ...
								 <TR class="detailTR1">
									...
									<TD class=queryTD2 id="tdReporttime">
											&nbsp;
									</TD>
									<TD class=queryTD1>
										报警类型：
									...
									<TD class=queryTD2  id="tdAlarmSubType">
										&nbsp;
									</TD>
								</TR>
