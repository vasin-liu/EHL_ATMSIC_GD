...
&nbsp;
								...
								<TR class="detailTR1" id="">
									...
									<TD class=queryTD2 id="tdRegNumber">
&nbsp;
									</TD>
									<TD class=queryTD1>
										车牌种类：
									</TD>
									<TD class=queryTD2 id="tdCardStyle" colspan=3></TD>
						...
						<TABLE cellSpacing=0 cellPadding=2 width="100%">
							<TBODY>
								...
								<!--  	<TD class=queryTD1>
									...
									<TD class=queryTD2 id="tdOnsignTime">
										&nbsp;
									</TD>
								 -->
									<TD class=queryTD1>
