...
<%
	...
	System.out.println(insrtOrUpdt+";"+bh);
%>
<html>
	<head>
		<title>道路管理</title>
                 ...
                 <tr>
                   ...
                   <td id="ZD1_DIV" align="left">
						<script language="javascript">
	                    	fillListBox("ZD1_DIV","ZD1","230","select jgid,jgmc from t_sys_department where substr(jgid,3,2)<>'00' and substr(jgid,5,2)='00'","全部");
                        </script>
					</td>
                </tr>
                <tr>
                    ...
                    <%--<td align="left" id="DLMC_TB_DIV">
                        <script language="javascript">
	                    	fillListBox("DLMC_TB_DIV","DLMC","230","select max(dlbh),max(dlmc) from T_OA_DICT_ROAD group by dlmc having count(dlbh)>=1","全部");
                        </script>
                    </td>--%>
                    <td class="td_r_b1" id="DLMC_TB_DIV">
                       <input id="DLMC" class="input1"  type="text" maxLength="50"/>
                       <input style="display:none" id="OLDDLMC" class="input1"  type="text" maxLength="50"/>
                    </td>
                </tr>
