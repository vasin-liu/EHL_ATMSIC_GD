											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td id="columnTd" align="left">
														<input type="text" name="ROADID" style="width:120"
															id="ROADID" maxLength="50"/>
													</td>
													<td class="currentLocation" style="text-align:right">
														<label>
															道路名称：
													...
													<td id="columnTd" align="left">
														<input type="text" name="ROADNAME" style="width:120"
															id="ROADNAME" maxLength="50"/>
													</td>
													<td>
														<div class="search">
													...
													<td>
														<div class="search">
															<a id="newroadhref" href="#"  onclick="onButtonClick('new_road')"
