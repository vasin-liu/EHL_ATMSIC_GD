	...
	<body align="center">
	  <!-- 地图显示 -->
		 <table width="100%" height="100%" align="center">
		    <tr id="infoTr" style="text-align:center;height:22" >
		       <td align="center" id="roadInfo">
		       </td>
		    </tr>
		    <tr height="30%">
		       <td>
			       <div id="news" style="position: relative; width: 100%; height: 152; background-color:#E0ECF8" >
			       </div>
		       </td>
		    </tr>
		    <tr id ="mapTr" style="text-align:center;height:22;" >
		       <td id="roadMap" align="right" style="padding-right:7px">
			       <a href="javascript:showGlobalMap();"><img id="im" src="../../image/biggest2.gif" onmouseover="changBgImg();" onmouseout="oldBgImg();" title="全图显示"></img></a>
		       </td>
		    </tr>
		    <tr>
		       <td>
