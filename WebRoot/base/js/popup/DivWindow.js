 ...
 * param tit 窗口标题
 * param msg 窗口内信息
 * param cloFunc 关闭回调方法
 */   
function xWin(id,w,h,l,t,tit,msg,cloFunc)    
{   
...
{    
	...
	+ "<span style='width:12;border-width:0px;color:white;font-family:webdings;' onclick='ShowHide(\""+this.id+"\",\""+this.cloFunc+"\")'>r</span>"   
	+ "</div>"   
	+ "<div style='"   
	+ "width:100%;"   
