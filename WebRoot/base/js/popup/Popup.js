            ...
            <tbody>\
              <tr height="5%" class="scrollColThead">\
                ...
                <td class="top" align="right" valign="middle">\
                  <img src="../../../base/image/popup/ok.gif" border="0" style="cursor:pointer" onclick="saveSelect();">\
                  <img src="../../../base/image/popup/cancel.gif" border="0" style="cursor:pointer" onclick="cancelSelect();">\
                </td>\
                <td class="corner" id="topright"></td>\
              </tr>\
