...
<html>
	<head>
		...
		<script type="text/javascript" src="../sm/js/sysmanage/sysParamMain.js"></script>
		...
		<style>
			...
			* { padding:0; margin:0}
			...
			<!--滤镜图片拉伸 -->
			#head_top{filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='images/head/head.gif',sizingMethod='scale');} 
			-->
		</style>
