...
//	this.dataItemDetailTdId = "dataItemDetailTdId";
//	this.dataItemDetailDescId = "dataItemDetailDescId";
//	this.dataItemDetailCodeId = "dataItemDetailCodeId";
...
//	this.dataItemDetailPart = 
//		"<table border='1'>\
//			<tr style='font-size:12px;'>\
//				<td id='"+this.dataItemDetailDescId+"'>\
//					数据类型：\
//				</td>	\
//				<td id='"+this.dataItemDetailCodeId+"'>\
//					<select>\
...
//	           <td id='"+this.dataItemDetailTdId+"'  align='left' style='display:none;' >\
//				    "+this.dataItemDetailPart+"\
//		        </td>\
	this.itemDetailPart = 
