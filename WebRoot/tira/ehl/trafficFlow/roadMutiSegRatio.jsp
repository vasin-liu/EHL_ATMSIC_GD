...
<%
	String title = FlowUtil.getFuncText("300508");
...
<script type="text/javascript"
	src="../../js/roadSeg/roadMutiSegRatio.js"></script>
<script type="text/javascript"
...
<!-- <script type="text/javascript">
	function getToday() {
		/* 	var today = new Date();
			document.getElementById('startDate').value = today.getFullYear() + "-"
					...
					<tr>
						...
						<td class="wTableCenterCenter" valign="top">
							<table width="800" border="0" cellspacing="0" cellpadding="0">
										...
										<table width="800" border="0" cellspacing="0" cellpadding="0">
											...
											<tr align="center" height="30">
												...
												<td class="currentLocation" style="text-align: left"
													colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
													name="days" type="checkbox" id="day1" value="1" /> 3天 <input
													name="days" type="checkbox" id="day2" value="2" /> 7天 <input
													name="days" type="checkbox" id="day3" value="3" /> 15天 <input
													name="days" type="checkbox" id="day4" value="4" /> 30天
												</td>
												<td align="center"><span class="lsearch"> <a
								...
								<tr>
									<td class="height" id="showTable" width="800"></td>
								</tr>
