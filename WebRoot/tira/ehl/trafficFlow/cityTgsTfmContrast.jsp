											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="70%" class="currentLocation">
														<span class="currentLocationBold">您当前的位置</span>：市卡口流量对比
													</td>
												</tr>
											</table>
										</td>
							...
							<td class="wTableCenterCenter" valign="top">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<script type="text/javascript">
									   ...
									   var str1 = " <chart palette='1' caption='市际卡口流量对比图' shownames='1' showvalues='0' showSum='1' decimals='0' overlapColumns='0' baseFont='宋体' baseFontSize='15' formatNumberScale='0'> " + 
											" <categories> " + 
											" <category label='清莲高速卡口' /> " + 
											" <category label='封川卡口' /> " + 
											" <category label='韶关仁化卡口' /> " + 
											" <category label='连平卡口' /> " + 
											" <category label='和平上陵卡口' /> " + 
											" <category label='上陵卡口' /> " + 
											" <category label='廉江卡口' /> " + 
											" </categories> " + 
											" <dataset seriesName='出市流量 单位(/辆)'  showValues='0'> " + 
											" <set value='25601' /> " + 
											" <set value='20148' /> " + 
											" <set value='17372' /> " + 
											" <set value='35407' /> " + 
											...
											" <set value='68105' /> " + 
											" </dataset> " + 
											" <dataset seriesName='入市流量 单位(/辆)' showValues='0'> " + 
											" <set value='57401' /> " + 
											" <set value='41941' /> " + 
											" <set value='45263' /> " + 
											" <set value='17320' /> " + 
