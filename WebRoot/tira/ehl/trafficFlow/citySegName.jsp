...
<%
	String title = FlowUtil.getFuncText("300505");
...
<script type="text/javascript" src="../../js/roadSeg/citySegName.js"></script>
<script type="text/javascript"
									...
									<td class="sleektd">
										<table width="800" border="0" cellspacing="0" cellpadding="0">
											<tr align="center" height="30">
												<td class="currentLocation" style="text-align: right;width: 70px;">
													<label> 统计方式： </label>
												</td>
												<td align="left">
                                                    <select id="type" style="width: 90px;" onchange="changeType()">
                                                ...
                                                <!-- Modified by Liuwx 2012-4-5 15:19:00 -->
                                                <td class="currentLocation" style="text-align: right;width: 70px;">
                                                    <label style="text-align: right"> 城市名称： </label>
                                                </td>
                                                <td align="left">
                                                   <div id="cityName_div"></div>
                                                </td>
                                                <td class="currentLocation" style="text-align: right">
                                                    <label style="text-align: right"> 卡口道路等级： </label>
                                                </td>
                                                <td align="left">
                                                    <select id="roadLevel" style="width: 70px;" onchange="changeSelectedValue();">
											...
											<tr align="center" height="30">
												...
												<td align="left" id="forDate" colspan="1"><input
													type="text" name="startHours"
													style="width: 90px; border: 1px #7B9EBD solid"
													id="startHours" maxLength="50" readonly value=''
													onclick="SelectDay(this);" />
												<td align="left" id="forMonth"
													style="display: none" colspan="3"><input type="text"
													name="startDay"
													style="width: 100px; border: 1px #7B9EBD solid"
												...
												<td align="left">
                                                    <div id="forwardName_div"></div>
                                                    <%--<select id="flowType" style="width: 90px;">
                                                            <option value="1">入城流量</option>
                                                            <option value="2">出城流量</option>
												...
												<td align="right" colspan="4">
                                                    ...
                                                    <span class="lsearch" style="margin-left: 10px;">
                                                        <a href="#" onclick="showExcel()" class="currentLocation">
