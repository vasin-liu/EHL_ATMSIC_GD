											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="70%" class="currentLocation">
														<span class="currentLocationBold">您当前的位置</span>：市际卡口流量趋势
													</td>
												</tr>
											</table>
										</td>
							...
							<td class="wTableCenterCenter" valign="top">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<script type="text/javascript">
									   ...
									   var str1 = "<chart caption='市际卡口24小时流量趋势' numdivlines='9' lineThickness='2' showValues='0' anchorRadius='3' anchorBgAlpha='50' showAlternateVGridColor='1' numVisiblePlot='12' animation='0' baseFont='宋体' baseFontSize='15' formatNumberScale='0'> " + 
											" <categories > " + 
											...
											" </categories> " + 
											" <dataset seriesName='蕉城北市际卡口' color='800080' anchorBorderColor='800080'> " + 
											" <set value='2673' /> " + 
											" <set value='1026' /> " + 
											" <set value='2470' /> " + 
											" <set value='2813' /> " + 
											...
											" </dataset> " + 
											" <dataset seriesName='平远市际卡口' color='FF8040' anchorBorderColor='FF8040'> " + 
											" <set value='2763' /> " + 
											" <set value='3149' /> " + 
											" <set value='3637' /> " + 
											" <set value='4015' /> " + 
											...
											" <set value='691' /> " + 
											" </dataset> " + 
											" <dataset seriesName='饶平市际卡口' color='FFFF00' anchorBorderColor='FFFF00' > " + 
											" <set value='3918' /> " + 
											" <set value='4140' /> " + 
											" <set value='4296' /> " + 
											" <set value='4519' /> " + 
											...
											" <set value='889' /> " + 
											" </dataset> " + 
											" <dataset seriesName='潮州汕汾市际卡口' color='FF0080' anchorBorderColor='FF0080' > " + 
											" <set value='2365' /> " + 
											" <set value='2433' /> " + 
											" <set value='2559' /> " + 
											" <set value='2823' /> " + 
