							...
							<td class="wTableCenterCenter" valign="top">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<script type="text/javascript">
									   ...
									   var str1 = "<chart caption='G206平远省际卡口同比分析图' numdivlines='9' lineThickness='2' showValues='0' anchorRadius='3' anchorBgAlpha='50' showAlternateVGridColor='1' numVisiblePlot='12' animation='0' baseFont='宋体' baseFontSize='15' formatNumberScale='0'> " + 
											" <categories > " + 
											" <category label='10月1日' /> " + 
											" <category label='10月2日' /> " + 
											" <category label='10月3日' /> " + 
											" <category label='10月4日' /> " + 
											" <category label='10月5日' /> " + 
											" <category label='10月6日' /> " + 
											" <category label='10月7日' /> " + 
											" </categories> " + 
											" <dataset seriesName='2009年' > " + 
											" <set value='1673' /> " + 
											" <set value='1026' /> " + 
											" <set value='2470' /> " + 
											" <set value='2813' /> " + 
