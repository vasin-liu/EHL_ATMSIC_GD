											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr align="center" height="30">
													...
													<td id="roadDescTdId" align="right" class="currentLocation">
														<p id="roadDescPId" align="right" >国道：</p>
														<input id="roadLevelInputId" type="hidden" value="1">
													</td>
													<td id="roadCodeTdId" align="right" class="currentLocation">
														<script type="text/javascript">
															var sql = "select roadid,roadname from t_oa_road_info where roadlevel=1";
