...
<html>
										...
										<td class="sleektd">
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr align="center" height="30">
													<td id="statTypeTdId" align="right" class="currentLocation">
														<p id="statTypePId" align="right">统计类别：</p>
													</td>
													<td align="right" class="currentLocation">
											        ...
											        <td id="analysisBtnTdId" align="right" valign="bottom" rowspan="2"  class="currentLocation">
											    ...
											    <tr height="30">
													...
													<td id="roadDescTdId" align="right" class="currentLocation">
														<p id="roadDescPId" align="right" >高速公路：</p>
														<input id="roadLevelInputId" type="hidden" value="0">
													</td>
													<td id="roadCodeTdId" align="right" class="currentLocation">
														<script type="text/javascript">
															var sql = "select roadid,roadname from t_oa_road_info where roadlevel=0 and roadid=gbid";
															fillListBox("roadCodeTdId","roadSelId","110",sql,"全部","doAnalysis(true)","setStatItem","");
														</script>
													</td>
											    </tr>
											</table>
	...
	<script type="text/javascript">
		function setStatItem() {
			var obj = $("roadSelId");
			if(obj.value != ""){
				$("statTypeSelectId").options[1].selected = true;
				$("statTypeSelectId").disabled = true;
			}else{
				$("statTypeSelectId").options[0].selected = true;
				$("statTypeSelectId").disabled = false;
			}
		}
	</script>
</html>
