...
<body style="padding:0" onload="setHomePage('30','<%=uname %>')">
<!--内容-->
      ...
      <tr>
          ...
          <td>
              <div class="mainbody" style="width:100%">
			    <iframe frameborder="0" id="moduletarget" name="moduletarget"   scrolling="auto" noresize="noresize"  src="" style="height:540px; *height:540px !important; *height:522px; VISIBILITY: inherit; WIDTH: 100%; Z-INDEX: 1;padding-top:6px;"  allowtransparency="true"> </iframe>
			  </div>
          </td>
      </tr>
  </table>
