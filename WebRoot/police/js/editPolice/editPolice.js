...
function receiveReport(res,feedbackid,alarmid) {
   var returnValuestr = window.showModalDialog("../policeEdit/receiveReport.jsp?feedbackid="+feedbackid+"&alarmid="+alarmId+"&depttype="+depttype+"&deptcode="+deptcode, "", "dialogWidth:400px;dialogHeight:350px"); 
