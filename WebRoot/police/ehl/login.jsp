...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>登录页面</title>
		<script type="text/javascript" src="dispatch/js/common/prototype.js"></script>
	...
	<body>
		<form id="userform" name="userform" action="dispatch.userlogin.login.d"
			...
			<table width="700" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td height="81" background="dispatch/images/login/top.gif">
						&nbsp;
					</td>
				</tr>
				<tr>
					<td height="78" background="dispatch/images/login/nav.gif">
						&nbsp;
					</td>
				</tr>
				<tr>
