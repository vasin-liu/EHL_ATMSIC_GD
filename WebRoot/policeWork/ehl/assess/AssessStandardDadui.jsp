...
<%
String title = FlowUtil.getFuncText("880902");	
%>
		...
		<fieldset style="width:100%;height:100%;border:1px solid #CCCCCC" align="center">
            ...
            <table width="99%" align="center" class="tableInput" id="dataTable">
                ...
                <tr>
                    ...
                    <td class="td_r_b"><input maxLength="8" id="acc_001024"  class="input1" type="text" readonly="true" oncontextmenu="return(false)" onfocus="this.blur()" />分</td>
                </tr>
                <tr>
                    <td class="td_r_b">2</td>
                    <td class="td_r_b1">及时报送交通拥堵信息（加分）<span style="color:red;font-size:11px;display: none;">※</span></td>
                    <td class="td_r_b"><input maxLength="8" id="crowd_001002"   class="input1" type="text" readonly="true" oncontextmenu="return(false)" onfocus="this.blur()" />分</td>
                </tr>
                <tr>
                    <td class="td_r_b">3</td>
                    <td class="td_r_b1">及时报送施工占道信息（加分）<span style="color:red;font-size:11px;display: none;">※</span></td>
                    <td class="td_r_b"><input maxLength="8" id="build_001023" class="input1" type="text" readonly="true" oncontextmenu="return(false)" onfocus="this.blur()" />分</td>
                </tr>
                <tr>
                    <td class="td_r_b">4</td>
                    <td class="td_r_b1">报送信息被省局采（加分）<span style="color:red;font-size:11px;display: none;">※</span></td>
                    <td class="td_r_b"><input maxLength="8" id="news_001004"  class="input1" type="text" readonly="true" oncontextmenu="return(false)" onfocus="this.blur()" />分</td>
                </tr>
                <tr>
                    <td class="td_r_b">5</td>
                    <td class="td_r_b1">报送信息被部局采用（加分）<span style="color:red;font-size:11px;display: none;">※</span></td>
                    <td class="td_r_b"><input maxLength="8" id="news_001006"  class="input1" type="text" readonly="true" oncontextmenu="return(false)" onfocus="this.blur()" />分</td>
                </tr>
                <tr>
                    <td class="td_r_b">6</td>
                    <td class="td_r_b1">报送调研信息被省局采用（加分）<span style="color:red;font-size:11px;display: none;">※</span></td>
                    <td class="td_r_b"><input maxLength="8" id="news_001008"  class="input1" type="text" readonly="true" oncontextmenu="return(false)" onfocus="this.blur()" />分</td>
                </tr>
                 <tr>
                    <td class="td_r_b">7</td>
                    <td class="td_r_b1">报送调研信息被部局采用（加分）<span style="color:red;font-size:11px;display: none;">※</span></td>
                    <td class="td_r_b"><input maxLength="8" id="news_001009"  class="input1" type="text" readonly="true" oncontextmenu="return(false)" onfocus="this.blur()" />分</td>
                </tr>
                <tr>
                    <td class="td_r_b">8</td>
                    <td class="td_r_b1">及时回应和处理群众或交通电台反映的拥堵报料信息（加分）<span style="color:red;font-size:11px;display: none;">※</span></td>
                    <td class="td_r_b"><input maxLength="8" id="baoliao_001001"  class="input1" type="text" readonly="true" oncontextmenu="return(false)" onfocus="this.blur()" />分</td>
                </tr>
                <tr>
                    ...
                    <td class="td_r_b"><input maxLength="8" id="baoliao_001007"  class="input1" type="text" readonly="true" oncontextmenu="return(false)" onfocus="this.blur()" />分</td>
                </tr>
                <tr>
                    ...
                    <td class="td_r_b"><input maxLength="8" id="baoliao_001005"  class="input1" type="text" readonly="true" oncontextmenu="return(false)" onfocus="this.blur()" />分</td>
                </tr>
                <tr>
                    ...
                    <td class="td_r_b"><input maxLength="8" id="kou_001003"  class="input1" type="text" readonly="true" oncontextmenu="return(false)" onfocus="this.blur()" />分</td>
                </tr>
                <tr>
            ...
            <table>
            	...
            	<tr>
                	...
                	<td>
                		<a name="navibutton" href="../../../广东公安交通管理信息编报工作暂行规定.mht" title="广东公安交通管理信息编报工作暂行规定" target="_blank">
							<span class="currentLocation">&nbsp;&nbsp;&nbsp;&nbsp;《广东公安交通管理信息编报工作暂行规定》点击查看</span>
					    </a>
                	</td>
                </tr>
