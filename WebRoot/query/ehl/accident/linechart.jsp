...
<body class="body" >
	  <div   align = "center" >
	     	<img src="tira.LineChart.draw.d?timetype=<%=timetype%>&stattype=<%=stattype%>&starttime=<%=starttime%>&endtime=<%=endtime%>&monthYear=<%=monthYear%>&monthMonth=<%=monthMonth%>&year=<%=year%>"/>
      </div>
</body>
</html>
