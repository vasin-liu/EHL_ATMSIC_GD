...
<html>
  <head>
	...
	<script type="text/javascript" src="../../js/violation/viostat.js"></script>
...
<body class="body" onload="viostat.initTime();">
   <div id="dContainer" class="table_tab" align = "center">
      <ul id="tags" align = "center">
         <li class='selectTag'><div  class="td_2">违法信息统计</div>
         </li>
      </ul>
	<!--查询区域2009-4-15-->
	  <div id="tagContent"  align = "center" >
	     <div id="info" class='tagContent selectTag'>	
	     	<table align ="left" >
		     	<tr>
		     		<td width = "100px">统计方式：</td>
		     		<td>
		     			<div style ="width:220px;border-style :solid ;border-width :1px;border-color:#BFBFBF">
		     				<input type = "radio" name = "statmode" value="1"  checked ="true"></input>行政辖区
		     				<input type = "radio" name = "statmode" value="2" ></input>违法地点
		     				<input type = "radio" name = "statmode" value="3" ></input>违法行为
		     			</div>
		     		</td>
		     		<td width = "60px">&nbsp;&nbsp;时间：</td>
		     		<td>
		     			<div style ="width:100px;border-style :solid ;border-width :1px;border-color:#BFBFBF">
		     				<input type = "radio" name = "timemode" value="1" onclick = "viostat.show('hourAndDate')" checked ="true"></input>小时
		     				<input type = "radio" name = "timemode" value="2" onclick = "viostat.show('hourAndDate')"></input>日
		     				<br>
		     				<input type = "radio" name = "timemode" value="3" onclick = "viostat.show('week')"></input>周
		     				&nbsp;&nbsp;&nbsp;
		     				<input type = "radio" name = "timemode" value="4" onclick = "viostat.show('month')"></input>月
		     			</div>
		     		</td>
		     		...
		     		<td width = "50px">
		     			<input name="query"  type="image" src="../../image/button/btnstat.gif" onclick = "viostat.doClick()"/>
