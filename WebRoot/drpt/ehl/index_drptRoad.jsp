...
<%
	...
	String path = StringHelper.obj2str(request.getHeader("host"),"");
	//当前用户信息
...
<html>
	<head>
		...
		<SCRIPT src="../../drpt/js/prompter/prompter.js" type=text/javascript></SCRIPT>
		<SCRIPT src="../../base/js/style1/iframe.js" type=text/javascript></SCRIPT>
		<style type="text/css">
			#msg li{line-height:18px;height:18px;margin-top:2px;}
			#msg a{padding:1px 7px; line-height:16px; margin:0px 1px 0px 0px; text-decoration: underline; color:#07679c;float:none;}
			#msg a:hover{background:#ededed;color:#ff6633;}
			#msg a.selected{text-decoration:none; background:#3384ad; color:white;}
			#msg a.selected:hover{background:#3384ad;}
			#prompt_nav span{height:16px;}
			table tr{line-height:16px;}
			table tr td{font-size:12px;}
		</style>
		<script type="text/javascript">
			function privCtrls(){
				var url = "common.treectrl.load.d?showtree=97";
				url = encodeURI(url);
				var params ="";
	...
	<body style="padding:0;margin: 0" onload="">
		<div id="pagebody">
			<table width="100%">
				<tr>
					<td width="10">
