...
<%
	...
	System.out.println("violation.jsp "+pnameObj);
											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="70%" class="currentLocation">
														<span class="currentLocationBold">您当前的位置</span>：客运车违法登记
													</td>
												</tr>
											</table>
										</td>
							...
							<td class="wTableCenterCenter" valign="top">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td class="sleektd">
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr height="10px" style="display:none"><td></td></tr>
												<tr style="display:none">
													...
													<td id="columnTd" align="left">
														<input type="text" name="HPHM" style="width:120;IME-MODE:inactive"
													...
													<td id="columnTd" align="left">
														<input type="text" name="CCLD" style="width:120;IME-MODE:inactive"
												...
												<tr style="display:none">
													...
													<td id="columnTd" align="left">
														<input type="text" name="CSDW" style="width:120;IME-MODE:inactive"
													...
													<td id="columnTd" align="left">
														<input type="text" name="JSZ" style="width:120;IME-MODE:inactive"
															id="JSZ" maxLength="30"/>
													</td>
												</tr>
												<tr height="10px" style="display:none"><td></td></tr>
												<tr  style="display:none">
													...
													<td id="ZD_DIV" align="left">
														<script language="javascript">
									                    	fillListBox("ZD_DIV","ZD","170","select jgid,jgmc from t_sys_department where substr(jgid,3,2)<>'00' and substr(jgid,5,2)='00'","全部","ZDCallBack()","ZDOnChange");
								                        </script>
													</td>
													<td class="currentLocation" style="text-align:right">
														<label>
												...
												<tr>
													<td colspan="6" align="center">
														<table width="95%">
															<tr align="center">
																<td style="color:red;font-size:14px;padding-left:10px;">春运期间违法登记信息，随查随报</td>
																<td>
																	<div class="search">
