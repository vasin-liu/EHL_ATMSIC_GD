...
<html>
	...
	<body style="background:none; padding-top:0px;" onLoad="doViewOnLoad();">
											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="70%" class="currentLocation">
														<span class="currentLocationBold">您当前的位置</span>：客运车违法浏览
													</td>
												</tr>
											</table>
										</td>
											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td id="ZD_DIV" align="left">
														<script language="javascript">
									                    	fillListBox("ZD_DIV","ZD","170","select jgid,jgmc from t_sys_department where substr(jgid,3,2)<>'00' and substr(jgid,5,2)='00' order by jgid","全部","ZDCallBack()","ZDOnChange");
								                        </script>
													</td>
													<td class="currentLocation" style="text-align:right">
														<label>
													...
													<td id="DD_DIV" align="left">
														<script language="javascript">
									                    	fillListBox("DD_DIV","DD","170","select jgid,jgmc from t_sys_department where substr(jgid,5,2)<>'00' order by jgid","全部","DDCallBack()");
								                        </script>
													</td>
													<td class="currentLocation" style="text-align:right">
														<label></label>
													...
													<td id="columnTd" align="left">
														<div class="search" style="float:right;margin-right:26px">
															<a href="#" onclick="onButtonClick('viewSearch','<%= jgbh %>')"
