...
//		var zhiduiTdId=document.getElementById('zhiduiTdId').selectedIndex.text;
        ...
        var danwei ="";
        //alert('2='+document.getElementById('zhiduiId').selectedIndex());
        //alert('document.getElementById('zhiduiTdId').options(document.getElementById('zhiduiTdId').selectedIndex).text='+document.getElementById('zhiduiTdId').options(document.getElementById('zhiduiTdId').selectedIndex).text);
        if (dadui == '全部'){
        	danwei = zhidui;
        }else{
        	danwei = dadui;
		...
		//var zhiduiTdId=document.getElementById('zhiduiTdId').options(document.getElementById('zhiduiTdId').selectedIndex).text;
		//alert(zhiduiTdId);
		//debugger;
		 
		
		//var daduiTdId=document.getElementById('daduiTdId').selectedIndex.text;
		...
		var reporter="   填表人                           审核人                           联系电话";
		var reporter = "<TABLE  id=titleTable cellSpacing=0 cellPadding=0 width=\99%\" align=center>";
		reporter +="<tr><td colspan='8' height='30px'></td></tr>"+
			"<TR>"+
			    "<td width='5%' align=\"left\"></td>"+
				"<td width='30%' align=\"left\">填表人</td>"+
				"<td width='35%' colspan='2' align=\"left\">"+ "审核人"+"</td>"+
				"<td width='30%' colspan=\"3\" align=\"left\"> 联系电话："+"</td>"+
			"</TR></table>";
		newwin.document.write(style+queryHTML+dataHTML+reporter); 
