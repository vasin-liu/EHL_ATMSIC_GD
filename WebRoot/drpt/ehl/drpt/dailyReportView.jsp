...
<html>
	...
	<body style="background:none; padding-top:0px;" onLoad="doOnLoad('',true);">
												...
												<tr align="center" height="35">
													...
													<td>
														<div class="search currentLocation" style="float:right;margin-right:25px;">
															<a href="#" onclick="doOnLoad(null,true)"
										...
										<td id="tdData">
											<table width="100%" border="0" cellpadding="0"
												...
												<tr class="titleTopBack">
													...
													<th width='5%' class='td_r_b td_font' style="display:none;">删除</th>
												</tr>
											</table>
										</td>
									</tr>
