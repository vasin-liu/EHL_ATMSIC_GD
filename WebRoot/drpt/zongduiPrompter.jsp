...
<html>
	<%
		...
		//System.out.println("zongdui++++++++++++++++++"+sql);
		Object[][] result = DBHandler.getMultiResult(sql);
	%>
	<head>
		<title>各个支队日报提交状态</title>
...
<body >
	<div id="tdData" class="scrollDivWarinng" >
		<table class="table" >
			<tr>
				<td class="wTableTopCenter" width="50%"style="text-align:center;border-bottom: 1 solid #A5D1EC;">支队名称</td>
				<td class="wTableTopCenter" width="30%"style="text-align:center;border-left: 1 solid #A5D1EC;border-bottom: 1 solid #A5D1EC;">日报表是否提交</td>
				<td class="wTableTopCenter" width="20%"style="text-align:center;border-left: 1 solid #A5D1EC;border-bottom: 1 solid #A5D1EC;">提交时间</td>
			</tr>
			<%
